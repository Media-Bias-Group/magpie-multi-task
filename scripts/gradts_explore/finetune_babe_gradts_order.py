"""Script for executing the GradTS selection phase."""
import wandb
...
for i in range(59):
    set_random_seed(321)
    wandb.init(project=EXPERIMENT_NAME, name="pretrained-first-" + str(i + 1) + "-finetuning")
    config["pretrained_path"] = "model_files/first_" + str(i) + "_tasks.pth"
