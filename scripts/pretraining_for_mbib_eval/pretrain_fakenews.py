...
from training.data import all_tasks,liar_72,fake_news_net_25,pheme_12
...
all_tasks.remove(fake_news_net_25)
all_tasks.remove(pheme_12)
...
set_random_seed()
wandb.init(project=EXPERIMENT_NAME, name="fakenews-mtl")
