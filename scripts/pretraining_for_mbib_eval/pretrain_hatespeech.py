...
from training.data import all_tasks,jigsaw_40,hateXplain_92,reddit_bias_75,online_harassment_dataset_87
...
tasks = all_tasks
all_tasks.remove(jigsaw_40)
all_tasks.remove(hateXplain_92)
all_tasks.remove(reddit_bias_75)
all_tasks.remove(online_harassment_dataset_87)
...
set_random_seed()
wandb.init(project=EXPERIMENT_NAME, name="hatespeech-mtl")
