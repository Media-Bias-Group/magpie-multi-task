...
from training.data import all_tasks,liar_72,multidimnews_19,rtgender_105,reddit_bias_75
...
tasks = all_tasks
all_tasks.remove(liar_72)
all_tasks.remove(multidimnews_19)
all_tasks.remove(rtgender_105)
...
set_random_seed()
wandb.init(project=EXPERIMENT_NAME, name="multiple-mtl")
